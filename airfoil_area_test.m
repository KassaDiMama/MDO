...
function plotAirfoilWithPartialArea(x_common, upper_y, lower_y, ...
    ...
    % Mark chord boundaries
    xline(start_percent/100, '--', 'Color', [0.5, 0.5, 0.5], 'LineWidth', 1.5,'HandleVisibility', 'off');
    xline(end_percent/100, '--', 'Color', [0.5, 0.5, 0.5], 'LineWidth', 1.5,'HandleVisibility', 'off');
